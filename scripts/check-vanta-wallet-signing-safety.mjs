...
assert.ok(policy.releaseGateCommands.includes("npm run swap:turnkey-liquidity-signer-dry-run-check"));
...
assert.ok(policy.releaseGateCommands.includes("npm run wallet:safe-send-hook-check"));
