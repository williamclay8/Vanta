...
const releaseCandidateId = "private-core-release-candidate:send-chain-unshield-roundtrip";
...
try {
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-chain->unshield shipping-check output\n${shippingCheckOutput}`,
    );
  }
  ...
  if (
    ...
    throw new Error(
      blockedReleaseCandidateCheckJsonOutput ||
        "send-chain->unshield release-candidate-check-json did not fail with structured output",
    );
  }
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-chain->unshield release-candidate json output\n${JSON.stringify(releaseCandidateJson, null, 2)}`,
    );
  }
  printStatus("private-core send-chain->unshield release-candidate json: PASS");
  ...
  if (
    ...
    throw new Error(
      releaseCandidateOutput ||
        "send-chain->unshield release-candidate returned unexpected output",
    );
  }
  printStatus("private-core send-chain->unshield release-candidate: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-chain->unshield operator-status-check output\n${operatorStatusCheckOutput}`,
    );
  }
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-chain->unshield operator-snapshot-check output\n${operatorSnapshotCheckOutput}`,
    );
  }
