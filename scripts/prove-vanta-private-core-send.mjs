...
const circuitDir = resolve(repoRoot, "zk/noir/vanta_private_core_single_note_send");
...
const compiledProgramPath = resolve(
  circuitDir,
  "target/vanta_private_core_single_note_send.json",
);
const witnessPath = resolve(circuitDir, "target/vanta_private_core_single_note_send.gz");
const proofReceiptPath = resolve(
  circuitDir,
  "target/vanta_private_core_single_note_send.proof.json",
);
...
try {
  ...
  try {
    ...
    writeFileSync(
      ...
      `${JSON.stringify(
        {
          circuit: "vanta_private_core_single_note_send",
          backend: "barretenberg-ultrahonk",
          witnessSource: "target/vanta_private_core_single_note_send.gz",
          bytecodeSource: "target/vanta_private_core_single_note_send.json",
