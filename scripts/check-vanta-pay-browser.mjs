  ...
  const steps = [
    ...
    { action: "wait_for", condition: "network_idle" },
    {
      ...
      checks: [
        ...
        { kind: "text_visible", text: "Subscriptions" },
        { kind: "text_visible", text: "Refunds" },
        { kind: "text_visible", text: "Withdrawals" },
        { kind: "text_visible", text: "Reconciliation" },
        { kind: "text_visible", text: "Developer controls" },
        { kind: "text_visible", text: "Embeddable suite preview" },
        { kind: "text_visible", text: "API keys" },
        { kind: "text_visible", text: "Signed webhooks" },
        ...
        { kind: "text_visible", text: "Fill in the payment details to preview the merchant request." },
