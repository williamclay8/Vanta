  ...
  const steps = [
    ...
    { action: "wait_for", condition: "network_idle" },
    {
      ...
      checks: [
        ...
        { kind: "text_visible", text: "Create a test checkout session before live approval or production settlement." },
        ...
        { kind: "text_visible", text: "Creates a test checkout session. Completion uses a local test private-rail receipt." },
