  ...
  const steps = [
    ...
    { action: "wait_for", condition: "network_idle" },
    {
      ...
      checks: [
        ...
        { kind: "text_visible", text: "Vanta Pay preview" },
        { kind: "text_visible", text: "Create a payment request" },
        { kind: "text_visible", text: "Build a checkout preview, review the transaction, and copy a test link." },
        { kind: "text_visible", text: "Beta preview" },
        { kind: "text_visible", text: "No funds move in beta mode" },
        ...
        { kind: "text_visible", text: "Vanta Pay is a preview." },
    ...
    { action: "click", selector: 'form[aria-label="Payment form"] .button-primary' },
    {
      action: "assert",
      checks: [
        { kind: "text_visible", text: "Preview ready" },
        { kind: "text_visible", text: "cs_test_design-retainer_" },
        { kind: "text_visible", text: "receipt.preview/design-retainer-" },
        { kind: "text_visible", text: "Preview request created." },
