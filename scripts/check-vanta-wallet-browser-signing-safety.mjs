  ...
  const steps = [
    ...
    { action: "wait_for", condition: "network_idle" },
    {
      ...
      checks: [
        ...
        { kind: "text_visible", text: "You'll receive" },
        { kind: "text_visible", text: "Shielded note" },
        { kind: "text_visible", text: "Own wallet" },
        ...
        { kind: "text_hidden", text: "anonymous" },
        { kind: "text_hidden", text: "untraceable" },
        { kind: "text_hidden", text: "fully private" },
        { kind: "text_hidden", text: "Awaiting wallet confirmation" },
        { kind: "text_hidden", text: "mainnet-beta" },
        { kind: "text_hidden", text: "seed phrase" },
        { kind: "text_hidden", text: "private key" },
