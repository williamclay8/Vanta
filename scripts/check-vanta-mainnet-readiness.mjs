...
assert.ok(snapshot.realFundsApproval.approvalActionRef);
assert.ok(snapshot.realFundsApproval.approvalActionSummary);
assert.ok(["mainnet-beta", "mainnet"].includes(snapshot.realFundsApproval.approvalEnvironment));
assert.ok(snapshot.realFundsApproval.feePayerRef);
assert.ok(snapshot.realFundsApproval.rollbackPlanRef);
