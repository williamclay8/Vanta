...
assert(
  packet.localSunspotPublicWitnessBindingObservationRef?.status ===
    "local-public-witness-binding-observed-not-production",
  "public-witness binding status mismatch",
);
for (const marker of [
  "decodes the /private/tmp public witness",
...
for (const [id, shape] of [
  ...
  ["public-witness-artifact", "artifact:<public-witness-values-ref-no-private-witness>"],
