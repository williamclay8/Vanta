...
try {
  ...
  if (
    ...
    initialSummaryState.parsed?.summaryVersion !== 43 ||
  ...
  if (
    ...
    summaryStateAfterConsume.parsed?.summaryVersion !== 43 ||
  ...
  if (
    ...
    summaryStateAfterRelease.parsed?.summaryVersion !== 43 ||
  ...
  if (
    ...
    !operatorStatusOutput.includes("Mirrored contract version: 19") ||
    !operatorStatusOutput.includes("Summary version: 43") ||
  ...
  if (
    ...
    throw new Error(
      blockedOperatorStatusCheckJsonOutput ||
        "operator http operator-status-check json did not fail with structured output",
    );
  }
  ...
  if (
    ...
    throw new Error(
      blockedOperatorStatusCheckJsonOutput ||
        "operator http operator-status-check json did not report the expected blocker",
    );
  }
  ...
  if (
    ...
    shippingDecisionState.parsed?.decisionNote !==
      "No private send transition is available for boundary checks yet." ||
    shippingDecisionState.parsed?.contractVersion !== 19 ||
    shippingDecisionState.parsed?.summaryVersion !== 43 ||
  ...
  if (
    ...
    blockedShippingCheckJsonSurface.mirroredContractVersion !== 19 ||
    blockedShippingCheckJsonSurface.summaryVersion !== 43 ||
  ...
  if (
    ...
    blockedOperatorSnapshotCheckJsonSurface.contract?.contractVersion !== 19 ||
    blockedOperatorSnapshotCheckJsonSurface.contract?.summaryVersion !== 43 ||
  ...
  if (
    ...
    operatorStatusState.parsed?.summary?.contractVersion !== 19 ||
    operatorStatusState.parsed?.summary?.summaryVersion !== 43 ||
    operatorStatusState.parsed?.shippingDecision?.contractVersion !== 19 ||
    operatorStatusState.parsed?.shippingDecision?.summaryVersion !== 43
  ) {
    throw new Error(operatorStatusState.text || "operator status endpoint returned unexpected output");
  }
  printStatus("operator http status endpoint: PASS");
  ...
  if (
    ...
    throw new Error(
      operatorStatusCheckState.text ||
        "operator status-check endpoint returned unexpected output",
    );
  }
  printStatus("operator http status-check endpoint: PASS");
  ...
  if (
    ...
    operatorSnapshotState.parsed?.contract?.contractVersion !== 19 ||
    operatorSnapshotState.parsed?.contract?.summaryVersion !== 43 ||
    ...
    operatorSnapshotState.parsed?.status?.summary?.contractVersion !== 19 ||
    operatorSnapshotState.parsed?.status?.summary?.summaryVersion !== 43 ||
    ...
    throw new Error(
      operatorSnapshotState.text || "operator http snapshot endpoint returned invalid data",
    );
  }
  ...
  if (
    ...
    throw new Error(
      shippingArtifactCheckState.text ||
        "shipping-artifact-check endpoint returned unexpected output",
    );
  }
  ...
  if (
    ...
    operatorSnapshotJson.status?.summary?.contractVersion !== 19 ||
    operatorSnapshotJson.status?.summary?.summaryVersion !== 43 ||
  ...
  if (
    ...
    throw new Error(
      blockedShippingArtifactCheckJsonOutput ||
        "operator http shipping-artifact-check-json did not fail with structured output",
    );
  }
  ...
  if (
    ...
    throw new Error(
      `Unexpected operator http shipping-artifact-check-json output\n${JSON.stringify(
  ...
  printStatus("operator http shipping-artifact-check-json surface: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected operator shipping artifact JSON output\n${JSON.stringify(
  ...
  printStatus("operator http shipping-artifact json: PASS");
  ...
  if (
    ...
    throw new Error(
      shippingArtifactOutput ||
        "operator http shipping-artifact surface returned unexpected output",
    );
  }
  printStatus("operator http shipping-artifact surface: PASS");
} catch (error) {
