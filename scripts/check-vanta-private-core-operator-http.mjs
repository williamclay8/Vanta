...
try {
  ...
  if (
    ...
    initialSummaryState.parsed?.summaryVersion !== 35 ||
  ...
  if (
    ...
    summaryStateAfterConsume.parsed?.summaryVersion !== 35 ||
  ...
  if (
    ...
    summaryStateAfterRelease.parsed?.summaryVersion !== 35 ||
  ...
  if (
    ...
    !operatorStatusOutput.includes("Summary version: 35") ||
