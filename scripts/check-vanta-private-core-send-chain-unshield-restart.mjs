...
try {
  ...
  printStatus("private-core send-chain->unshield restart operator-status json: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-chain->unshield restart operator snapshot JSON output\n${JSON.stringify(operatorSnapshotJson, null, 2)}`,
    );
  }
  printStatus("private-core send-chain->unshield restart operator-snapshot json: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-chain->unshield restart operator snapshot output\n${operatorSnapshotOutput}`,
    );
  }
  printStatus("private-core send-chain->unshield restart operator-snapshot: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-chain->unshield restart shipping-check output\n${shippingCheckOutput}`,
    );
  }
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-chain->unshield restart shipping-artifact-check json output\n${JSON.stringify(shippingArtifactJson, null, 2)}`,
    );
  }
  printStatus("private-core send-chain->unshield restart shipping-artifact-check json: PASS");
  ...
  if (
    ...
    throw new Error(
      shippingArtifactOutput ||
        "send-chain->unshield restart shipping-artifact-check returned unexpected output",
    );
  }
  printStatus("private-core send-chain->unshield restart shipping-artifact-check: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-chain->unshield restart shipping-artifact json output\n${JSON.stringify(shippingArtifactSurfaceJson, null, 2)}`,
    );
  }
  printStatus("private-core send-chain->unshield restart shipping-artifact json: PASS");
  ...
  if (
    ...
    throw new Error(
      shippingArtifactSurfaceOutput ||
        "send-chain->unshield restart shipping-artifact returned unexpected output",
    );
  }
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-chain->unshield restart operator-snapshot-check json output\n${JSON.stringify(operatorSnapshotCheckJson, null, 2)}`,
    );
  }
  printStatus("private-core send-chain->unshield restart operator-snapshot-check json: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-chain->unshield restart operator-status-check json output\n${JSON.stringify(operatorStatusCheckJson, null, 2)}`,
    );
  }
  printStatus("private-core send-chain->unshield restart operator-status-check json: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-chain->unshield restart operator-status-check output\n${operatorStatusCheckOutput}`,
    );
  }
  printStatus("private-core send-chain->unshield restart operator-status-check: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-chain->unshield restart operator-snapshot-check output\n${operatorSnapshotCheckOutput}`,
    );
  }
  printStatus("private-core send-chain->unshield restart operator-snapshot-check: PASS");
