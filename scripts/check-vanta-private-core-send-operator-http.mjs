...
try {
  ...
  if (
    ...
    summaryState.parsed?.summaryVersion !== 47 ||
    ...
    summaryState.parsed?.supportedSwapLaneKind !== "single-input-usdc-to-allowlisted-shielded-output" ||
    ...
    summaryState.parsed?.supportedSendResultingRootBasis !== "proof-linked-input-expected-root" ||
  ...
  if (
    ...
    transitionResponse.parsed?.resultingRootBasis !== "proof-linked-input-expected-root" ||
  ...
  if (
    ...
    sendState.parsed.latestSend?.resultingRootBasis !== "proof-linked-input-expected-root" ||
  ...
  if (
    ...
    summaryAfterTransition.parsed?.latestSend?.resultingRootBasis !== "proof-linked-input-expected-root" ||
