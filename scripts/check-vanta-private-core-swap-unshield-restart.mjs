...
const outputAssetId = "0x7573646300000000000000000000000000000000000000000000000000000000";
...
try {
  ...
  const expectedStatusLines = [
    ...
    "Latest swap output: 1250000 / 0x75736463...000000",
    ...
    "Released value: 1250000 / 0x75736463...000000",
    "Release records: 1",
  ...
  if (
    ...
    operatorStatusJson.summary?.latestSwap?.outputAmount !== "1250000" ||
    operatorStatusJson.summary?.latestRelease?.releasedAmount !== "1250000" ||
  ...
  if (
    ...
    operatorSnapshotJson.status?.summary?.latestSwap?.outputAmount !== "1250000" ||
    operatorSnapshotJson.status?.summary?.latestRelease?.releasedAmount !== "1250000" ||
  ...
  if (
    ...
    throw new Error(
      `Unexpected swap->unshield restart operator snapshot output\n${operatorSnapshotOutput}`,
    );
  }
  printStatus("private-core swap->unshield restart operator-snapshot: PASS");
  ...
  if (
    ...
    !blockedShippingOutput.includes("Mirrored contract version: 22") ||
    !blockedShippingOutput.includes("Summary version: 46") ||
    ...
    throw new Error(
      blockedShippingOutput ||
        "swap->unshield restart shipping-check did not fail with the expected blocker",
    );
  }
  ...
  if (
    ...
    throw new Error(
      blockedShippingArtifactCheckJsonOutput ||
        "swap->unshield restart shipping-artifact-check json did not fail with structured output",
    );
  }
  ...
  if (
    ...
    blockedShippingArtifactJson.contractVersion !== 22 ||
    blockedShippingArtifactJson.summaryVersion !== 46 ||
    blockedShippingArtifactJson.snapshot?.shipping?.shippingStatusRaw !==
      "required-lanes-mismatch"
  ) {
    throw new Error(
      `Unexpected swap->unshield restart shipping-artifact-check json failure\n${JSON.stringify(blockedShippingArtifactJson, null, 2)}`,
    );
  }
  printStatus("private-core swap->unshield restart shipping-artifact-check json: PASS");
  ...
  if (
    ...
    !blockedShippingArtifactCheckOutput.includes("Contract version: 22") ||
    !blockedShippingArtifactCheckOutput.includes("Summary version: 46") ||
    ...
    throw new Error(
      blockedShippingArtifactCheckOutput ||
        "swap->unshield restart shipping-artifact-check did not fail with the expected blocker",
    );
  }
  printStatus("private-core swap->unshield restart shipping-artifact-check: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected swap->unshield restart shipping-artifact json output\n${JSON.stringify(shippingArtifactSurfaceJson, null, 2)}`,
    );
  }
  printStatus("private-core swap->unshield restart shipping-artifact json: PASS");
  ...
  if (
    ...
    throw new Error(
      shippingArtifactSurfaceOutput ||
        "swap->unshield restart shipping-artifact returned unexpected output",
    );
  }
  printStatus("private-core swap->unshield restart shipping-artifact: PASS");
  ...
  if (
    ...
    throw new Error(
      blockedOperatorSnapshotCheckJsonOutput ||
        "swap->unshield restart operator-snapshot-check json did not fail with structured output",
    );
  }
  ...
  if (
    ...
    blockedOperatorSnapshotJson.contract?.contractVersion !== 22 ||
    blockedOperatorSnapshotJson.contract?.summaryVersion !== 46 ||
    ...
    throw new Error(
      `Unexpected swap->unshield restart operator-snapshot-check json failure\n${JSON.stringify(blockedOperatorSnapshotJson, null, 2)}`,
    );
  }
  ...
  if (
    ...
    throw new Error(
      blockedOperatorSnapshotCheckOutput ||
        "swap->unshield restart operator-snapshot-check did not fail with the expected blocker",
    );
  }
  printStatus("private-core swap->unshield restart operator-snapshot-check: PASS");
