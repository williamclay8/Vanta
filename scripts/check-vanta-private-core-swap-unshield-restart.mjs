...
try {
  ...
  if (
    ...
    !blockedShippingOutput.includes("Mirrored contract version: 23") ||
    !blockedShippingOutput.includes("Summary version: 47") ||
  ...
  if (
    ...
    blockedShippingArtifactJson.contractVersion !== 23 ||
    blockedShippingArtifactJson.summaryVersion !== 47 ||
  ...
  if (
    ...
    !blockedShippingArtifactCheckOutput.includes("Contract version: 23") ||
    !blockedShippingArtifactCheckOutput.includes("Summary version: 47") ||
  ...
  if (
    ...
    blockedOperatorSnapshotJson.contract?.contractVersion !== 23 ||
    blockedOperatorSnapshotJson.contract?.summaryVersion !== 47 ||
