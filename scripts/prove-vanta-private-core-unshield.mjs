...
const compiledProgramPath = resolve(
  circuitDir,
  "target/vanta_private_core_single_note_unshield.json",
);
const witnessPath = resolve(
  circuitDir,
  "target/vanta_private_core_single_note_unshield.gz",
);
const proofReceiptPath = resolve(
  circuitDir,
  "target/vanta_private_core_single_note_unshield.proof.json",
);
      ...
      `${JSON.stringify(
        {
          ...
          witnessSource: "target/vanta_private_core_single_note_unshield.gz",
          bytecodeSource: "target/vanta_private_core_single_note_unshield.json",
