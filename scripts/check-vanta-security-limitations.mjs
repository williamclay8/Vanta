...
const requiredPhrases = [
  ...
  "Shield, Claim, actual-private-spend, and Send may also return",
  ...
  "wrap those Shield, Claim, Send, and actual-private-spend worker artifacts into `VantaPrivatePoolV2ProofResult` values only for exact bound proof requests",
