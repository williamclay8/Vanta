...
const requiredPhrases = [
  ...
  "wrap those Send and actual-private-spend worker artifacts into `VantaPrivatePoolV2ProofResult` values only for exact bound proof requests",
  "requiring `local-bb-derived-artifact`",
