...
const requiredPhrases = [
  ...
  "Shield, Claim, Swap-to-shielded, actual-private-spend, and Send may also return",
  "local actual-private-spend witness-input proof path",
  "dev-only Claim browser/Web Worker proof-execution path",
  "dev-only Swap-to-shielded browser/Web Worker proof-execution path",
  ...
  "generate a Claim witness in the worker from typed Claim witness input using NoirJS",
  "generate a Swap-to-shielded witness in the worker from typed Swap-to-shielded witness input using NoirJS",
  ...
  "return a no-witness Claim `local-bb-derived-artifact`",
  "return a no-witness Swap-to-shielded `local-bb-derived-artifact`",
  "return a no-witness actual-private-spend `local-bb-derived-artifact`",
  "opt-in browser-worker proof-result adapter",
  "wrap those Shield, Claim, Swap-to-shielded, Send, and actual-private-spend worker artifacts into `VantaPrivatePoolV2ProofResult` values only for exact bound proof requests",
  "requiring `local-bb-derived-artifact`",
  "not wired into live Claim execution",
  "not wired into live Swap-to-shielded execution",
