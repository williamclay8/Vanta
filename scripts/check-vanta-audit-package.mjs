...
const requiredPhrases = [
  ...
  "blocked-no-reviewed-production-output-manifest",
  ...
  "VANTA_C01_PRODUCTION_OUTPUT_MANIFEST_ROOT=<returned-artifact-dir>",
  "VANTA_C01_PRODUCTION_OUTPUT_MANIFEST_PATH=<refs-only-output-manifest-json>",
