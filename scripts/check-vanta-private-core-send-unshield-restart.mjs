...
try {
  ...
  printStatus("private-core send->unshield restart operator-status: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield restart operator-status JSON output\n${JSON.stringify(operatorStatusJson, null, 2)}`,
    );
  }
  printStatus("private-core send->unshield restart operator-status json: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield restart operator snapshot JSON output\n${JSON.stringify(operatorSnapshotJson, null, 2)}`,
    );
  }
  printStatus("private-core send->unshield restart operator-snapshot json: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield restart operator snapshot output\n${operatorSnapshotOutput}`,
    );
  }
  printStatus("private-core send->unshield restart operator-snapshot: PASS");
  ...
  if (
    ...
    throw new Error(`Unexpected send->unshield restart shipping-status output\n${shippingStatusOutput}`);
  }
  printStatus("private-core send->unshield restart shipping-status: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield restart shipping-status JSON output\n${JSON.stringify(shippingStatusJson, null, 2)}`,
    );
  }
  printStatus("private-core send->unshield restart shipping-status json: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield restart shipping-check output\n${shippingCheckOutput}`,
    );
  }
  printStatus("private-core send->unshield restart shipping-check: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield restart shipping-artifact-check json output\n${JSON.stringify(shippingArtifactJson, null, 2)}`,
    );
  }
  printStatus("private-core send->unshield restart shipping-artifact-check json: PASS");
  ...
  if (
    ...
    throw new Error(
      shippingArtifactOutput ||
        "send->unshield restart shipping-artifact-check returned unexpected output",
    );
  }
  printStatus("private-core send->unshield restart shipping-artifact-check: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield restart shipping-artifact json output\n${JSON.stringify(shippingArtifactSurfaceJson, null, 2)}`,
    );
  }
  printStatus("private-core send->unshield restart shipping-artifact json: PASS");
  ...
  if (
    ...
    throw new Error(
      shippingArtifactSurfaceOutput ||
        "send->unshield restart shipping-artifact returned unexpected output",
    );
  }
  printStatus("private-core send->unshield restart shipping-artifact: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield restart operator-snapshot-check json output\n${JSON.stringify(operatorSnapshotCheckJson, null, 2)}`,
    );
  }
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield restart operator-status-check output\n${operatorStatusCheckOutput}`,
    );
  }
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield restart operator-snapshot-check output\n${operatorSnapshotCheckOutput}`,
    );
  }
  printStatus("private-core send->unshield restart operator-snapshot-check: PASS");
