...
const spec = {
  "id": "T10",
  "title": "Unlink/Euler Institutional Private Lending Privacy",
  "scriptFile": "check-unlink-euler-institutional-private-lending-privacy.mjs",
  "npmScript": "twitter-pass-2026-06-12-unlink-euler-check",
  "watchPath": "/Users/clay/Desktop/Vanta Vault/02 Projects/Unlink-Euler-Institutional-Lending-Watch-Item.md",
  "stateMarkers": [
    "id: T10",
    "Unlink/Euler Institutional Private Lending Privacy",
    "unlink_euler_institutional_private_lending_details:",
    "institutional selective disclosure",
    "https://x.com/i/status/2065449637352501467"
  ],
  "docMarkers": [
    "T10 - Unlink/Euler Institutional Private Lending Privacy",
    "institutional selective disclosure",
    "privacy + compliance + UX triangle",
    "https://www.unlink.xyz/blog/euler-private-institutional-lending"
  ],
  "vaultMarkers": [
    "T10 - Unlink/Euler Institutional Private Lending Privacy",
    "Building privacy in 5 lines of code",
    "https://x.com/i/status/2065449637352501467"
  ],
  "watchMarkers": [
    "Unlink + Euler Finance",
    "@unlink_xyz",
    "@phklive",
