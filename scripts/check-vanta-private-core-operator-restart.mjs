...
try {
  ...
  if (
    ...
    preRestartSummary.parsed?.supportedSwapLaneKind !== "single-input-usdc-to-allowlisted-shielded-output" ||
    ...
    preRestartSummary.parsed?.supportedSendResultingRootBasis !== "proof-linked-input-expected-root" ||
  ...
  if (
    ...
    postRestartSummary.parsed?.supportedSwapLaneKind !== "single-input-usdc-to-allowlisted-shielded-output" ||
    ...
    postRestartSummary.parsed?.supportedRootRegistrationProvenance !==
      "shield-input|send-recipient-output|send-change-output|swap-output" ||
    postRestartSummary.parsed?.supportedSendResultingRootBasis !== "proof-linked-input-expected-root" ||
