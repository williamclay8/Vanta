...
assert.ok(manifest.releaseGates.includes("npm run mainnet:role-service-replay-status"));
assert.ok(manifest.releaseGates.includes("npm run mainnet:role-service-replay-evidence-check"));
