    ...
    steps: [
      {
        ...
        checks: [
          ...
          {
            kind: "text_visible",
            text: "Beta mode keeps Strategy visible while live execution stays locked.",
          },
          { kind: "text_visible", text: "Advanced strategy settings" },
          { kind: "text_hidden", text: "Pay from" },
          { kind: "text_hidden", text: "Settle to" },
          { kind: "text_hidden", text: "Preview DCA" },
          { kind: "text_hidden", text: "Preview TWAP" },
          ...
          { kind: "text_visible", text: "Strategy receipt packet" },
          { kind: "text_visible", text: "Hash-bound packet preview" },
          ...
          {
            kind: "text_visible",
            text: "This screen shapes a local strategy preview. No funds move and no trades are submitted.",
          },
    ...
    steps: [
      {
        ...
        checks: [
          { kind: "url_contains", text: "/app/strategy" },
          { kind: "text_visible", text: "Strategy" },
          { kind: "text_visible", text: "Preview strategy" },
      ...
      { action: "wait_for", condition: "text_visible", value: "Pay from" },
      { action: "select_option", selector: 'select[aria-label="Pay from"]', value: "Public wallet" },
      {
        action: "assert",
        checks: [
          { kind: "text_visible", text: "Preview strategy" },
          { kind: "text_visible", text: "Trade size variation" },
          { kind: "text_visible", text: "Schedule pattern" },
          { kind: "text_visible", text: "How fast to complete" },
          { kind: "text_visible", text: "Submit method" },
          { kind: "text_visible", text: "Settle to" },
          {
            kind: "text_visible",
