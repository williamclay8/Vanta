...
try {
  ...
  await runScenario({
    ...
    steps: [
      ...
      { action: "select_option", selector: 'select[aria-label="Fund from"]', value: "Public balance" },
      {
        action: "assert",
        checks: [
          { kind: "text_visible", text: "Review strategy plan" },
  ...
  await runScenario({
    ...
    steps: [
      ...
      { action: "select_option", selector: 'select[aria-label="Fund from"]', value: "External wallet" },
      {
        action: "assert",
        checks: [
