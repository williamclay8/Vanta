...
try {
  ...
  printStatus("private-core send->unshield operator-status json: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield operator snapshot JSON output\n${JSON.stringify(operatorSnapshotJson, null, 2)}`,
    );
  }
  printStatus("private-core send->unshield operator-snapshot json: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield operator snapshot output\n${operatorSnapshotOutput}`,
    );
  }
  printStatus("private-core send->unshield operator-snapshot: PASS");
  ...
  if (
    ...
    throw new Error(`Unexpected send->unshield shipping-status output\n${shippingStatusOutput}`);
  }
  ...
  if (
    ...
    throw new Error(`Unexpected send->unshield shipping-check output\n${shippingCheckOutput}`);
  }
  printStatus("private-core send->unshield shipping-check: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield shipping-artifact-check json output\n${JSON.stringify(shippingArtifactJson, null, 2)}`,
    );
  }
  printStatus("private-core send->unshield shipping-artifact-check json: PASS");
  ...
  if (
    ...
    throw new Error(
      shippingArtifactOutput ||
        "send->unshield shipping-artifact-check returned unexpected output",
    );
  }
  printStatus("private-core send->unshield shipping-artifact-check: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield shipping-artifact json output\n${JSON.stringify(shippingArtifactSurfaceJson, null, 2)}`,
    );
  }
  printStatus("private-core send->unshield shipping-artifact json: PASS");
  ...
  if (
    ...
    throw new Error(
      shippingArtifactSurfaceOutput ||
        "send->unshield shipping-artifact returned unexpected output",
    );
  }
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield operator-snapshot-check json output\n${JSON.stringify(operatorSnapshotCheckJson, null, 2)}`,
    );
  }
  printStatus("private-core send->unshield operator-snapshot-check json: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield operator-status-check json output\n${JSON.stringify(operatorStatusCheckJson, null, 2)}`,
    );
  }
  printStatus("private-core send->unshield operator-status-check json: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield operator-status-check output\n${operatorStatusCheckOutput}`,
    );
  }
  printStatus("private-core send->unshield operator-status-check: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send->unshield operator-snapshot-check output\n${operatorSnapshotCheckOutput}`,
    );
  }
  printStatus("private-core send->unshield operator-snapshot-check: PASS");
