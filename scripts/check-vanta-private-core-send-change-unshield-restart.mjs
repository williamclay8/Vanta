...
const releaseCandidateId = "private-core-release-candidate:send-change-unshield-restart";
...
try {
  ...
  printStatus("private-core send-change->unshield restart input root registration: PASS");
  ...
  printStatus("private-core send-change->unshield restart setup: PASS");
  ...
  if (
    ...
    preRestartSummary.parsed?.currentRoot !== heldChange.witness.root ||
    ...
    preRestartSummary.parsed?.sendResultingRootRecord?.root !== heldChange.witness.root ||
    ...
    preRestartSummary.parsed?.sendResultingRootRegistrationStatus !== "linked-change-output" ||
  ...
  printStatus("private-core send-change->unshield restart pre-shutdown state: PASS");
  ...
  if (
    ...
    postRestartSummary.parsed?.currentRoot !== heldChange.witness.root ||
    ...
    postRestartSummary.parsed?.sendResultingRootRecord?.root !== heldChange.witness.root ||
    ...
    postRestartSummary.parsed?.sendResultingRootRegistrationStatus !== "linked-change-output" ||
  ...
  printStatus("private-core send-change->unshield restart persisted state: PASS");
  ...
  const expectedStatusLines = [
    ...
    "Supported swap lane note: Current constrained swap lane supports one VUSD input note into one allowlisted shielded output note through operator-backed execution, including Meteora-aware shielded SOL and direct shielded token output lanes.",
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-change->unshield restart operator-status JSON output\n${JSON.stringify(operatorStatusJson, null, 2)}`,
    );
  }
  printStatus("private-core send-change->unshield restart operator-status json: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-change->unshield restart operator snapshot JSON output\n${JSON.stringify(operatorSnapshotJson, null, 2)}`,
    );
  }
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-change->unshield restart shipping-status JSON output\n${JSON.stringify(shippingStatusJson, null, 2)}`,
    );
  }
  ...
  if (
    ...
    !shippingCheckOutput.includes("Mirrored contract version: 22") ||
    !shippingCheckOutput.includes("Summary version: 46") ||
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-change->unshield restart shipping-artifact-check json output\n${JSON.stringify(shippingArtifactJson, null, 2)}`,
    );
  }
  printStatus("private-core send-change->unshield restart shipping-artifact-check json: PASS");
  ...
  if (
    ...
    !shippingArtifactOutput.includes("Summary version: 46") ||
    ...
    throw new Error(
      shippingArtifactOutput ||
        "send-change->unshield restart shipping-artifact-check returned unexpected output",
    );
  }
  printStatus("private-core send-change->unshield restart shipping-artifact-check: PASS");
  ...
  if (
    ...
    shippingArtifactSurfaceJson.contractVersion !== 22 ||
    shippingArtifactSurfaceJson.summaryVersion !== 46 ||
    shippingArtifactSurfaceJson.snapshot?.shipping?.shippingStatusRaw !== "ready-narrow-v1"
  ) {
    throw new Error(
      `Unexpected send-change->unshield restart shipping-artifact json output\n${JSON.stringify(shippingArtifactSurfaceJson, null, 2)}`,
    );
  }
  printStatus("private-core send-change->unshield restart shipping-artifact json: PASS");
  ...
  if (
    ...
    !shippingArtifactSurfaceOutput.includes("Contract version: 22") ||
    !shippingArtifactSurfaceOutput.includes("Summary version: 46") ||
    ...
    throw new Error(
      shippingArtifactSurfaceOutput ||
        "send-change->unshield restart shipping-artifact returned unexpected output",
    );
  }
  printStatus("private-core send-change->unshield restart shipping-artifact: PASS");
  ...
  if (
    ...
    throw new Error(
      blockedReleaseCandidateCheckJsonOutput ||
        "send-change->unshield restart release-candidate-check-json did not fail with structured output",
    );
  }
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-change->unshield restart release-candidate json output\n${JSON.stringify(releaseCandidateJson, null, 2)}`,
    );
  }
  printStatus("private-core send-change->unshield restart release-candidate json: PASS");
  ...
  if (
    ...
    throw new Error(
      releaseCandidateOutput ||
        "send-change->unshield restart release-candidate returned unexpected output",
    );
  }
  printStatus("private-core send-change->unshield restart release-candidate: PASS");
  ...
  if (
    ...
    operatorSnapshotCheckJson.contract?.contractVersion !== 22 ||
    operatorSnapshotCheckJson.contract?.summaryVersion !== 46 ||
    ...
    throw new Error(
      `Unexpected send-change->unshield restart operator-snapshot-check json output\n${JSON.stringify(operatorSnapshotCheckJson, null, 2)}`,
    );
  }
  ...
  if (
    ...
    operatorStatusCheckJson.summary?.contractVersion !== 22 ||
    operatorStatusCheckJson.summary?.summaryVersion !== 46 ||
    ...
    throw new Error(
      `Unexpected send-change->unshield restart operator-status-check json output\n${JSON.stringify(operatorStatusCheckJson, null, 2)}`,
    );
  }
  printStatus("private-core send-change->unshield restart operator-status-check json: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-change->unshield restart operator-status-check output\n${operatorStatusCheckOutput}`,
    );
  }
  printStatus("private-core send-change->unshield restart operator-status-check: PASS");
  ...
  if (
    ...
    throw new Error(
      `Unexpected send-change->unshield restart operator-snapshot-check output\n${operatorSnapshotCheckOutput}`,
    );
  }
  ...
  if (!replay.text.includes("has already been consumed")) {
    throw new Error(replay.text || "send-change->unshield replay rejection did not survive restart");
  }
  printStatus("private-core send-change->unshield restart replay rejection: PASS");

  const rootStorePath = join(tempRoot, "roots.json");
  const tamperedRootStore = JSON.parse(readFileSync(rootStorePath, "utf8"));
  tamperedRootStore.roots[heldChange.witness.root].noteCommitment = inputSourceArtifacts.noteCommitment;
  ...
  printStatus("private-core send-change->unshield restart tampered output continuity: PASS");
} catch (error) {
