...
const requiredPhrases = [
  ...
  "The production indexer and prover services have live public health evidence",
  "Production relayer, verifier, and operator services still need to be deployed",
