...
const InternalCanonicalLifecycleProvingPanel = lazy(() =>
  import("@/components/InternalCanonicalLifecycleProvingPanel").then((m) => ({
    default: m.InternalCanonicalLifecycleProvingPanel,
  })),
);

const InternalCanonicalLifecycleExecutionPrimerPanel = lazy(() =>
  import("@/components/InternalCanonicalLifecycleExecutionPrimerPanel").then((m) => ({
    default: m.InternalCanonicalLifecycleExecutionPrimerPanel,
  })),
);
...
const InternalCanonicalLifecycleRunnerExecutionPanel = lazy(() =>
  import("@/components/InternalCanonicalLifecycleRunnerExecutionPanel").then((m) => ({
    default: m.InternalCanonicalLifecycleRunnerExecutionPanel,
  })),
);

const InternalCanonicalLifecycleFieldLanePanel = lazy(() =>
  import("@/components/InternalCanonicalLifecycleFieldLanePanel").then((m) => ({
    default: m.InternalCanonicalLifecycleFieldLanePanel,
  })),
);

const InternalCanonicalLifecycleFieldExecutionPanel = lazy(() =>
  import("@/components/InternalCanonicalLifecycleFieldExecutionPanel").then((m) => ({
    default: m.InternalCanonicalLifecycleFieldExecutionPanel,
  })),
);

const InternalCanonicalLifecycleDownstreamPanel = lazy(() =>
  import("@/components/InternalCanonicalLifecycleDownstreamPanel").then((m) => ({
    default: m.InternalCanonicalLifecycleDownstreamPanel,
  })),
);

const InternalCanonicalLifecyclePreEncodingTriagePanel = lazy(() =>
  import("@/components/InternalCanonicalLifecyclePreEncodingTriagePanel").then((m) => ({
    default: m.InternalCanonicalLifecyclePreEncodingTriagePanel,
  })),
);

const InternalCanonicalLifecyclePreEncodingArtifactPanel = lazy(() =>
  import("@/components/InternalCanonicalLifecyclePreEncodingArtifactPanel").then((m) => ({
    default: m.InternalCanonicalLifecyclePreEncodingArtifactPanel,
  })),
);

const InternalCanonicalLifecycleNextDownstreamBoundaryPanel = lazy(() =>
  import("@/components/InternalCanonicalLifecycleNextDownstreamBoundaryPanel").then((m) => ({
    default: m.InternalCanonicalLifecycleNextDownstreamBoundaryPanel,
  })),
);

const InternalCanonicalLifecycleNextDownstreamPlanningPanel = lazy(() =>
  import("@/components/InternalCanonicalLifecycleNextDownstreamPlanningPanel").then((m) => ({
    default: m.InternalCanonicalLifecycleNextDownstreamPlanningPanel,
  })),
);

const InternalCanonicalLifecycleNextDownstreamPreEncodingPanel = lazy(() =>
  import("@/components/InternalCanonicalLifecycleNextDownstreamPreEncodingPanel").then((m) => ({
    default: m.InternalCanonicalLifecycleNextDownstreamPreEncodingPanel,
  })),
);

const InternalCanonicalLifecycleDownstreamBoundaryFreezePanel = lazy(() =>
  import("@/components/InternalCanonicalLifecycleDownstreamBoundaryFreezePanel").then((m) => ({
    default: m.InternalCanonicalLifecycleDownstreamBoundaryFreezePanel,
  })),
);
...
const InternalCanonicalLifecycleLineageBranchPanel = lazy(() =>
...
const InternalCanonicalLifecycleGroupedEventsPanel = lazy(() =>
  import("@/components/InternalCanonicalLifecycleGroupedEventsPanel").then((m) => ({
    default: m.InternalCanonicalLifecycleGroupedEventsPanel,
  })),
);

const InternalCanonicalLifecycleLineageSummaryPanel = lazy(() =>
  import("@/components/InternalCanonicalLifecycleLineageSummaryPanel").then((m) => ({
    default: m.InternalCanonicalLifecycleLineageSummaryPanel,
  })),
);

const InternalCanonicalLifecycleEventCardPanel = lazy(() =>
  import("@/components/InternalCanonicalLifecycleEventCardPanel").then((m) => ({
    default: m.InternalCanonicalLifecycleEventCardPanel,
  })),
);

const InternalCanonicalLifecycleReconciliationCohortsPanel = lazy(() =>
  import("@/components/InternalCanonicalLifecycleReconciliationCohortsPanel").then((m) => ({
    default: m.InternalCanonicalLifecycleReconciliationCohortsPanel,
  })),
);
    ...
    <article className="dashboard-card">
      <details>
            ...
            <details style={{ marginTop: 12 }}>
              ...
              <div className="review-list" style={{ marginTop: 12 }}>
                ...
                <div style={{ display: "grid", gap: 8, marginTop: 4 }}>
                  ...
                  <Suspense fallback={<div className="status-panel">Loading proving and verification chain…</div>}>
                    <InternalCanonicalLifecycleProvingPanel lookupLifecycleId={lookupLifecycleId} />
                  </Suspense>
                </div>
                ...
                <div style={{ display: "grid", gap: 8, marginTop: 4 }}>
                  ...
                  <Suspense fallback={<div className="status-panel">Loading runner execution…</div>}>
                    <InternalCanonicalLifecycleRunnerExecutionPanel
                      encoderRunnerStartTicketFreeze={encoderRunnerStartTicketFreeze}
                      encoderRunnerExecutionInput={encoderRunnerExecutionInput}
                      encoderRunnerExecutionEntryPlan={encoderRunnerExecutionEntryPlan}
                      encoderRunnerExecutionEntryPlanFreeze={encoderRunnerExecutionEntryPlanFreeze}
                      encoderRunnerExecutionSession={encoderRunnerExecutionSession}
                      encoderRunnerExecutionSessionFreeze={encoderRunnerExecutionSessionFreeze}
                      encoderEncodingAdmission={encoderEncodingAdmission}
                      encoderEncodingAdmissionFreeze={encoderEncodingAdmissionFreeze}
                      encoderFieldEncodingStart={encoderFieldEncodingStart}
                      encoderFieldEncodingStartFreeze={encoderFieldEncodingStartFreeze}
                    />
                  </Suspense>
                  <div className="status-panel">
                    <div className="review-list">
                  ...
                  <Suspense fallback={<div className="status-panel">Loading field-lane diagnostics…</div>}>
                    <InternalCanonicalLifecycleFieldLanePanel
                      encoderRowFieldEmissionStart={encoderRowFieldEmissionStart}
                      encoderRowFieldEmissionStartFreeze={encoderRowFieldEmissionStartFreeze}
                      encoderFieldLaneExecutionAdmission={encoderFieldLaneExecutionAdmission}
                      encoderFieldLaneExecutionAdmissionFreeze={encoderFieldLaneExecutionAdmissionFreeze}
                      encoderFieldLaneExecutionStart={encoderFieldLaneExecutionStart}
                      encoderFieldLaneExecutionStartFreeze={encoderFieldLaneExecutionStartFreeze}
                    />
                  </Suspense>
                  <div className="status-panel">
                    <div className="review-list">
                  ...
                  <Suspense fallback={<div className="status-panel">Loading field execution…</div>}>
                    <InternalCanonicalLifecycleFieldExecutionPanel
                      encoderFieldMaterializationExecutionStart={encoderFieldMaterializationExecutionStart}
                      encoderFieldMaterializationExecutionStartFreeze={encoderFieldMaterializationExecutionStartFreeze}
                      encoderFieldMaterializationExecutionWorkEnvelope={encoderFieldMaterializationExecutionWorkEnvelope}
                      encoderFieldMaterializationExecutionWorkEnvelopeFreeze={encoderFieldMaterializationExecutionWorkEnvelopeFreeze}
                      encoderFieldMaterializationExecutionPlan={encoderFieldMaterializationExecutionPlan}
                      encoderFieldMaterializationExecutionPlanFreeze={encoderFieldMaterializationExecutionPlanFreeze}
                    />
                  </Suspense>
                  <div className="status-panel">
                    <div className="review-list">
                  ...
                  <Suspense fallback={<div className="status-panel">Loading downstream diagnostics…</div>}>
                    <InternalCanonicalLifecycleDownstreamPanel
                      encoderFieldMaterializationPlanningConsumerHandoffFreeze={encoderFieldMaterializationPlanningConsumerHandoffFreeze}
                      encoderFieldMaterializationDownstreamConsumer={encoderFieldMaterializationDownstreamConsumer}
                      encoderFieldMaterializationDownstreamConsumerFreeze={encoderFieldMaterializationDownstreamConsumerFreeze}
                      encoderFieldMaterializationDownstreamBoundaryHandoff={encoderFieldMaterializationDownstreamBoundaryHandoff}
                      encoderFieldMaterializationDownstreamBoundaryHandoffFreeze={encoderFieldMaterializationDownstreamBoundaryHandoffFreeze}
                      encoderFieldMaterializationDownstreamPlanningConsumer={encoderFieldMaterializationDownstreamPlanningConsumer}
                      encoderFieldMaterializationDownstreamPlanningConsumerFreeze={encoderFieldMaterializationDownstreamPlanningConsumerFreeze}
                    />
                  </Suspense>
                  <div className="status-panel">
                    <div className="review-list">
                  ...
                  <Suspense fallback={<div className="status-panel">Loading pre-encoding triage…</div>}>
                    <InternalCanonicalLifecyclePreEncodingTriagePanel
                      encoderFieldMaterializationDownstreamPreEncodingPlanningConsumerFreeze={encoderFieldMaterializationDownstreamPreEncodingPlanningConsumerFreeze}
                      encoderFieldMaterializationDownstreamPreEncodingPlanningBoundaryHandoff={encoderFieldMaterializationDownstreamPreEncodingPlanningBoundaryHandoff}
                      encoderFieldMaterializationDownstreamPreEncodingPlanningBoundaryHandoffFreeze={encoderFieldMaterializationDownstreamPreEncodingPlanningBoundaryHandoffFreeze}
                    />
                  </Suspense>
                  <div className="status-panel">
                    <div className="review-list">
                  ...
                  <Suspense fallback={<div className="status-panel">Loading downstream boundary freeze diagnostics…</div>}>
                    <InternalCanonicalLifecycleDownstreamBoundaryFreezePanel
                      encoderFieldMaterializationDownstreamPreEncodingPlanningBoundaryConsumerFreeze={encoderFieldMaterializationDownstreamPreEncodingPlanningBoundaryConsumerFreeze}
                      encoderFieldMaterializationNextDownstreamPreEncodingConsumer={encoderFieldMaterializationNextDownstreamPreEncodingConsumer}
                    />
                  </Suspense>
                  <Suspense fallback={<div className="status-panel">Loading next-downstream pre-encoding diagnostics…</div>}>
                    <InternalCanonicalLifecycleNextDownstreamPreEncodingPanel
                      encoderFieldMaterializationNextDownstreamPreEncodingConsumer={encoderFieldMaterializationNextDownstreamPreEncodingConsumer}
                      encoderFieldMaterializationNextDownstreamPreEncodingConsumerFreeze={encoderFieldMaterializationNextDownstreamPreEncodingConsumerFreeze}
                      encoderFieldMaterializationNextDownstreamPreEncodingPlanningConsumerHandoff={encoderFieldMaterializationNextDownstreamPreEncodingPlanningConsumerHandoff}
                      encoderFieldMaterializationNextDownstreamPreEncodingPlanningConsumerHandoffFreeze={encoderFieldMaterializationNextDownstreamPreEncodingPlanningConsumerHandoffFreeze}
                    />
                  </Suspense>
                  <Suspense fallback={<div className="status-panel">Loading next-downstream planning diagnostics…</div>}>
                    <InternalCanonicalLifecycleNextDownstreamPlanningPanel
                      encoderFieldMaterializationNextDownstreamPlanningBoundaryConsumer={encoderFieldMaterializationNextDownstreamPlanningBoundaryConsumer}
                      encoderFieldMaterializationNextDownstreamPlanningBoundaryConsumerFreeze={encoderFieldMaterializationNextDownstreamPlanningBoundaryConsumerFreeze}
                      encoderFieldMaterializationNextDownstreamPlanningBoundaryHandoff={encoderFieldMaterializationNextDownstreamPlanningBoundaryHandoff}
                      encoderFieldMaterializationNextDownstreamPlanningBoundaryHandoffFreeze={encoderFieldMaterializationNextDownstreamPlanningBoundaryHandoffFreeze}
                      encoderFieldMaterializationNextDownstreamPlanningConsumer={encoderFieldMaterializationNextDownstreamPlanningConsumer}
                      encoderFieldMaterializationNextDownstreamPlanningConsumerFreeze={encoderFieldMaterializationNextDownstreamPlanningConsumerFreeze}
                    />
                  </Suspense>
                </div>
              </div>
        ...
        <details style={{ marginTop: 12 }}>
          ...
          <Suspense fallback={<div className="status-panel">Loading reconciliation cohorts…</div>}>
            <InternalCanonicalLifecycleReconciliationCohortsPanel
              reconciliationCohorts={reconciliationCohorts}
              setLookupLifecycleId={setLookupLifecycleId}
              setLookupJumpTarget={setLookupJumpTarget}
            />
          </Suspense>
        </details>
        ...
        {mode === "chronological" ? (
          <div style={{ display: "grid", gap: 16, marginTop: 12 }}>
            {events.map((event, index) => (
              <Suspense
                key={event.id}
                fallback={<div className="status-panel">Loading chronological event…</div>}
              >
                <InternalCanonicalLifecycleEventCardPanel event={event} index={index} />
              </Suspense>
            ))}
          </div>
        ) : lineages.length === 0 ? (
          ...
          <div style={{ display: "grid", gap: 16, marginTop: 12 }}>
            {lineages.map((lineage, index) => (
              ...
              >
                ...
                <Suspense fallback={<div className="status-panel">Loading lineage summary…</div>}>
                  <InternalCanonicalLifecycleLineageSummaryPanel lineage={lineage} />
                </Suspense>
                ...
                <Suspense fallback={<div className="status-panel">Loading grouped lineage events…</div>}>
                  <InternalCanonicalLifecycleGroupedEventsPanel
                    lineage={lineage}
