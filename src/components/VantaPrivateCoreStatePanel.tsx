...
type VantaPrivateCoreStatePanelProps = {
  ...
  operatorZkV1ShippingPrimaryNote?: string | null;
  operatorZkV1ShippingStatusLabel?: string | null;
  ...
  operatorSupportedStatusNote?: string | null;
  ...
  operatorSupportedStatusGateNote?: string | null;
  ...
  operatorSupportedSnapshotGateNote?: string | null;
  ...
  operatorSupportedShippingDecisionGateNote?: string | null;
  ...
  operatorSupportedShippingDecisionNote?: string | null;
...
export function VantaPrivateCoreStatePanel({
  ...
  operatorZkV1ShippingPrimaryNote = null,
  operatorZkV1ShippingStatusLabel = null,
  ...
  operatorSupportedStatusNote = null,
  ...
  operatorSupportedStatusGateNote = null,
  ...
  operatorSupportedSnapshotGateNote = null,
  ...
  operatorSupportedShippingDecisionGateNote = null,
  ...
  operatorSupportedShippingDecisionNote = null,
      ...
      {!compact && shieldState && (
        <details className="shield-helper shield-helper--meta">
          ...
          <div className="review-list" style={{ marginTop: 12 }}>
            ...
            <div className="review-row">
              <span>Operator status note</span>
              <strong>{operatorSupportedStatusNote ?? "Unavailable"}</strong>
            </div>
            <div className="review-row">
            ...
            <div className="review-row">
              <span>Operator status gate note</span>
              <strong>{operatorSupportedStatusGateNote ?? "Unavailable"}</strong>
            </div>
            <div className="review-row">
            ...
            <div className="review-row">
              ...
              <strong>
                {operatorSnapshotKind
                  ? `v${String(operatorSnapshotVersion ?? 1)} · ${operatorSnapshotKind}`
                  : "Unavailable"}
              </strong>
            </div>
            <div className="review-row">
              <span>Operator snapshot note</span>
              <strong>{operatorSupportedSnapshotNote ?? "Unavailable"}</strong>
            </div>
            <div className="review-row">
            ...
            <div className="review-row">
              <span>Operator snapshot gate note</span>
              <strong>{operatorSupportedSnapshotGateNote ?? "Unavailable"}</strong>
            </div>
            <div className="review-row">
              <span>Operator snapshot gate transport</span>
              <strong>{operatorSupportedSnapshotGateTransport ?? "Unavailable"}</strong>
            </div>
            <div className="review-row">
              <span>Operator snapshot gate endpoint</span>
              <strong>{operatorSupportedSnapshotGateEndpoint ?? "Unavailable"}</strong>
            </div>
            <div className="review-row">
            ...
            <div className="review-row">
              <span>Shipping artifact identity</span>
              <strong>
                {operatorShippingArtifactKind
                  ? `v${String(operatorShippingArtifactVersion ?? 1)} · ${operatorShippingArtifactKind}`
                  : "Unavailable"}
              </strong>
            </div>
            <div className="review-row">
              <span>Shipping artifact note</span>
              <strong>{operatorSupportedShippingArtifactNote ?? "Unavailable"}</strong>
            </div>
            <div className="review-row">
            ...
            <div className="review-row">
              <span>Shipping artifact gate note</span>
              <strong>{operatorSupportedShippingArtifactGateNote ?? "Unavailable"}</strong>
            </div>
            <div className="review-row">
            ...
            <div className="review-row">
              ...
              <strong>
                {operatorShippingDecisionKind
                  ? `v${String(operatorShippingDecisionVersion ?? 1)} · ${operatorShippingDecisionKind}`
                  : "Unavailable"}
              </strong>
            </div>
            <div className="review-row">
              <span>Shipping decision contract note</span>
              <strong>{operatorSupportedShippingDecisionNote ?? "Unavailable"}</strong>
            </div>
            <div className="review-row">
            ...
            <div className="review-row">
              <span>Shipping decision gate note</span>
              <strong>{operatorSupportedShippingDecisionGateNote ?? "Unavailable"}</strong>
            </div>
            <div className="review-row">
            ...
            <div className="review-row">
              ...
              <strong>
                {operatorSupportedSendResultingRootBasis === "proof-linked-input-expected-root"
