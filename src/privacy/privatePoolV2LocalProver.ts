...
export class VantaPrivatePoolV2LocalBbFixtureProver implements VantaPrivatePoolV2Prover {
  ...
  readiness(): VantaPrivatePoolV2Readiness {
    ...
    return {
      ...
      ready: true,
      warnings: [
        "Local Private Pool v2 bb fixture prover replays verified local proof artifacts. Fixture artifacts are exact fixture replay; derived Shield, Claim, Swap-to-shielded, actual-private-spend, and Send artifacts are generated by local dev-only proof paths. Neither is a production ZK proof service.",
      ],
    };
  }
