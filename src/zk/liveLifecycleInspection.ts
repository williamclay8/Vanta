...
export type CanonicalLifecycleSuccessorSummary = {
  ...
  encoderProvingInputReadinessSummary?: string;
  ...
  encoderVerificationAttestationSummary?: string;
  encoderVerificationAttestationFreezeSummary?: string;
...
export function inspectCanonicalLifecycleNode(
  ...
  const encoderProvingInputReadiness =
    inspectGenericPhase1EncoderProvingInputReadinessForLifecycleNode(normalizedLifecycleId);
  const encoderProvingInputReadinessFreeze =
    inspectGenericPhase1EncoderProvingInputReadinessFreezeForLifecycleNode(normalizedLifecycleId);
  ...
  const encoderBackendProvingSessionFreeze =
    inspectGenericPhase1EncoderBackendProvingSessionFreezeForLifecycleNode(normalizedLifecycleId);
  ...
  const encoderVerificationAttestation =
    inspectGenericPhase1EncoderVerificationAttestationForLifecycleNode(normalizedLifecycleId);
  const encoderVerificationAttestationFreeze =
    inspectGenericPhase1EncoderVerificationAttestationFreezeForLifecycleNode(normalizedLifecycleId);
  ...
  for (const event of events) {
    ...
    if (successor) {
      ...
      return {
        ...
        encoderProvingInputReadinessSummary: encoderProvingInputReadiness.summary,
        ...
        encoderVerificationAttestationSummary: encoderVerificationAttestation.summary,
        encoderVerificationAttestationFreezeSummary: encoderVerificationAttestationFreeze.summary,
...
function createEncoderProvingInputReadinessSummary(
  result: ReturnType<typeof inspectGenericPhase1EncoderProvingInputReadinessForLifecycleNode>,
): string {
  return result.summary;
}

function createEncoderProvingInputReadinessFreezeSummary(
  result: ReturnType<typeof inspectGenericPhase1EncoderProvingInputReadinessFreezeForLifecycleNode>,
): string {
  return result.summary;
}

function createEncoderConstraintSystemHandoffReadinessSummary(
  result: ReturnType<typeof inspectGenericPhase1EncoderConstraintSystemHandoffReadinessForLifecycleNode>,
): string {
  return result.summary;
}

function createEncoderConstraintSystemHandoffReadinessFreezeSummary(
  result: ReturnType<typeof inspectGenericPhase1EncoderConstraintSystemHandoffReadinessFreezeForLifecycleNode>,
): string {
  return result.summary;
}

function createEncoderProvingInputPackageSummary(
  result: ReturnType<typeof inspectGenericPhase1EncoderProvingInputPackageForLifecycleNode>,
): string {
  return result.summary;
}

function createEncoderProvingInputPackageFreezeSummary(
  result: ReturnType<typeof inspectGenericPhase1EncoderProvingInputPackageFreezeForLifecycleNode>,
): string {
  return result.summary;
}

function createEncoderBackendProvingSessionSummary(
  result: ReturnType<typeof inspectGenericPhase1EncoderBackendProvingSessionForLifecycleNode>,
): string {
  return result.summary;
}

function createEncoderBackendProvingSessionFreezeSummary(
  result: ReturnType<typeof inspectGenericPhase1EncoderBackendProvingSessionFreezeForLifecycleNode>,
): string {
  return result.summary;
}

function createEncoderProofReceiptSummary(
  result: ReturnType<typeof inspectGenericPhase1EncoderProofReceiptForLifecycleNode>,
): string {
  return result.summary;
}
...
function createEncoderVerificationAttestationSummary(
  result: ReturnType<typeof inspectGenericPhase1EncoderVerificationAttestationForLifecycleNode>,
): string {
  return result.summary;
}

function createEncoderVerificationAttestationFreezeSummary(
  result: ReturnType<typeof inspectGenericPhase1EncoderVerificationAttestationFreezeForLifecycleNode>,
): string {
  return result.summary;
}
...
function normalizeShieldEvent(
  ...
  return {
    ...
    summary: "Public-wallet USDC entered the canonical shielded lifecycle as the first retained note.",
...
function normalizeSendEvent(
  ...
  return {
    ...
    summary: "A spendable USDC note evolved into retained successor note state without leaving shielded state.",
    liveReferenceLabel: "Consumed live note",
    liveReferenceValue: summary.predecessorLiveNoteId,
    assetSummary: `USDC send to ${summary.recipient}`,
...
function normalizeSwapEvent(
  ...
  return {
    ...
    summary: "A USDC predecessor note was consumed and a new shielded SOL successor note was retained in canonical state.",
    liveReferenceLabel: "Consumed live note",
...
function normalizeUnshieldEvent(
  ...
  return {
    ...
    title: summary.asset === "SOL" ? "SOL exit consumed" : "USDC exit consumed",
    summary: "A canonical note lifecycle endpoint was retained for a real operator-backed exit back to Public Wallet.",
    liveReferenceLabel: "Consumed note ref",
    liveReferenceValue: summary.consumedReferenceHash,
    ...
    canonicalConsumptionBasis: summary.canonicalConsumptionBasis,
    canonicalNullifierStub: summary.canonicalNullifierStub,
    predecessorLiveNoteId: summary.consumedReferenceHash,
