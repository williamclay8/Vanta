...
- this lane is maintained as an active-v0 legacy compatibility lane for current Send flows, not as the new production architecture; new circuit work should route toward the Private Pool v2 entry family or an explicitly reviewed replacement
