...
- fixture events: `receipt_generated`, `share_link_copied`, `counterparty_verifier_opened`, `next_private_settlement_requested`, `counterparty_invite_created`, `counterparty_invite_opened`, and `next_settlement_intent_created`
